...
import { CodeProgressWidgetComponent } from './code-progress-widget.component';
...
import {CodeProgressService} from '../code-progress.service';
import {DashboardService} from '../../../shared/dashboard.service';
import {NgModule, NO_ERRORS_SCHEMA} from '@angular/core';
import {Observable, of} from 'rxjs';
import {ICodeProgress, IServers, IUnits} from '../interfaces';
...
describe('DeployWidgetComponent', () => {
  let component: CodeProgressWidgetComponent;
  let deployService: CodeProgressService;
  let dashboardService: DashboardService;
  let modalService: NgbModule;
  let fixture: ComponentFixture<CodeProgressWidgetComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      providers: [
        {provide: CodeProgressService, useClass: MockDeployService}
      ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CodeProgressWidgetComponent);
    component = fixture.componentInstance;
    deployService = TestBed.get(CodeProgressService);
