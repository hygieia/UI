...
@Component({
  ...
  templateUrl: './code-progress-delete-form.component.html',
  styleUrls: ['./code-progress-delete-form.component.scss']
})
export class CodeProgressDeleteFormComponent implements OnInit {
