...
describe('CodeProgressService', () => {
  beforeEach(() => TestBed.configureTestingModule({
    imports: [HttpClientTestingModule, HttpClientModule],
    providers: [CodeProgressService]
  }));

  it('should be created', () => {
    const service: CodeProgressService = TestBed.get(CodeProgressService);
    expect(service).toBeTruthy();
  });

  it('should fetch valid deploy data',
    inject([HttpTestingController, CodeProgressService],
      (httpMock: HttpTestingController, service: CodeProgressService) => {
        // We call the service
