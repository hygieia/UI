...
import { CodeProgressConfigFormComponent } from './code-progress-config-form.component';
...
describe('CodeProgressConfigFormComponent', () => {
  let component: CodeProgressConfigFormComponent;
  let fixture: ComponentFixture<CodeProgressConfigFormComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CodeProgressConfigFormComponent);
