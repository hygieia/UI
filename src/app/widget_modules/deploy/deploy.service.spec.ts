      ...
      request.flush(
        {
          result: [
            {
              name : 'QA',
              url : 'https://shzjenkins-blue.cloud.capitalone.com/',
              units : [
                {
                  name : 'api.jar',
                  version : '2.0.5',
                  jobURL: 'https://shzjenkins-blue.cloud.capitalone.com/job/Non-PAR/job/Non-Prod-Jobs/job/Hygieia/job/2.x/job/Build/',
                  deployed : true,
